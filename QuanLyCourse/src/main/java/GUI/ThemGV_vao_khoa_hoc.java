 ...
 * @author ASUS
 */
public class ThemGV_vao_khoa_hoc extends javax.swing.JFrame {
     ...
     */
    public ThemGV_vao_khoa_hoc(int CourseID,String Title) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Phân công giảng viên");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ThemGV_vao_khoa_hoc.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ThemGV_vao_khoa_hoc(CourseID,Title).setVisible(true);
            }
        });
    }
