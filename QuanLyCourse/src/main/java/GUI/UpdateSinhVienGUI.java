 ...
 * @author ASUS
 */
public class UpdateSinhVienGUI extends javax.swing.JFrame {
    ...
    public String ED;
    /**
     * Creates new form UpdateSinhVienGUI
     */
    ...
    private void jButton_UpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_UpdateActionPerformed
        ...
        if (checkFN_LN()){
            String fn1 = jTextField_FN.getText().toString();
            String ln1 = jTextField_LN.getText().toString();
            svBLL.UpdateSinhVien(id, fn1, ln1);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(UpdateSinhVienGUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
...
//            public void run() {
//                new UpdateSinhVienGUI().setVisible(true);
//            }
//        });
    }
